...
const Settings = () => {
  ...
  const formatAxiosError = (err) => {
    ...
    if (!err.response || status === 500 || status === 502 || status === 503) {
      msg +=
        '. Start the API from the project folder: python web_app.py (must listen on port 8001 for Vite proxy).'
    }
    return msg
  }
    ...
    <div className="page">
      ...
      {apiReachable === false && (
        <div className="alert alert--danger">
          ...
          <code>http://127.0.0.1:8001</code>. In a separate terminal, from the project root, run:{' '}
      ...
      <div className="card">
        ...
        <button type="button" className="btn btn--success" style={{ width: 'auto' }} onClick={runFullPipeline} disabled={isRunning}>
      ...
      <div className="settings-grid">
        <div className="card">
          ...
          <p className="settings-card__desc">Download fresh SENSEX details and recent headlines for analysis.</p>
        ...
        <div className="card">
          ...
          <p className="settings-card__desc">Train and execute the PPO reinforcement learning agent.</p>
          <div className="btn-stack">
            <button
              type="button"
