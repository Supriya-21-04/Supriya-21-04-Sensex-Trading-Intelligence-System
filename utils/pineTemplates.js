...
// Stochastic, ADX, VWAP, Supertrend, Liquidity Sweep, FVG, Order Block, ChoCh`,
  ...
  const strategyName = `SENSEX Intelligence Strategy`
...
// ===== Alerts =====
if (longCondition)
    alert("SENSEX Intelligence: Long entry signal triggered", alert.freq_once_per_bar_close)
if (shortCondition)
    alert("SENSEX Intelligence: Exit signal triggered", alert.freq_once_per_bar_close)
`
